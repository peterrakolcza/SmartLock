...
class Lock(Accessory):
    ...
    def on_endpoint_authenticated(self, endpoint):
        ...
        self.set_lock_target_state(self._lock_target_state)
    ...
    def add_info_service(self):
        ...
        serv_info.configure_char("Manufacturer", value="DIY")
        serv_info.configure_char("SerialNumber", value="default")
        serv_info.configure_char("Model", value=version)
    ...
    def set_lock_target_state(self, value):
        ...
        try:
            ...
            self._lock_target_state = target_state_backup
            log.info("A network exception occurred when updating the state")
